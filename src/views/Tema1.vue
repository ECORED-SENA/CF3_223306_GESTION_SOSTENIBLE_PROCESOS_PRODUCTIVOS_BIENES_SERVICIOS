...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    h3.bgr_4.p-3.mb-5(data-aos="fade-down-right") Los equilibrios ecosistémicos 
    ...
    h4.bgr_4.p-3.mb-5(data-aos="fade-down-right") La resiliencia como estrategia adaptiva
    ...
    .row.mb-5
      ...
      .col-12.col-lg-4(data-aos="fade-left")
        figura.d-flex.justify-content-center
          img.img400(src='@/assets/curso/tema1/t1-7.png' alt='Texto que describa la imagen')
    
    h4.bgr_4.p-3.mb-5(data-aos="fade-down-right") Ciclos biogeoquímicos
    ...
    .row.bgr_5.p-4.mb-5
      ...
      .col-12.col-lg-2.d-flex.align-items-center
        figure
          img.img100.m-auto(src='@/assets/curso/tema1/t1-30.svg', alt='Texto que describa la imagen')
    ...
    .row.bgr_11.p-4.justify-content-center(data-aos="zoom-out")
      .col-12.col-lg-9
        .titulo-sexto.color-acento-contenido
          h5 Figura 3
      ...
      .row.mb-5
        .col-12.col-lg-4(data-aos="fade-right")
          figura.d-flex.justify-content-center.mb-3.mb-lg-0
            img.img350(src='@/assets/curso/tema1/t1-19.svg' alt='Texto que describa la imagen') 
        .col-12.col-lg-8.d-flex.align-items-center(data-aos="fade-left")
          div
    ...
    .bg_grad-02
      .row.justify-content-center(data-aos="flip-right")
        .col-12.col-lg-8
          ...
          figura
            img.pst_7(src='@/assets/curso/tema1/t1-21.svg' alt='Texto que describa la imagen') 
