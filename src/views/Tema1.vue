...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Un ecosistema es un conjunto de organismos vivos y seres no vivos independientes que comparten el mismo hábitat; relacionándose entre sí y con su ambiente al desintegrarse y volver a ser parte del ciclo de energía y de nutrientes, mediante procesos como el parasitismo, la simbiosis, la competencia y la depredación.
    ...
    h3.bgr_4.p-3.mb-5 Los equilibrios ecosistémicos 
    ...
    .bloque-texto-g.color-acento-contenido.pst_1.p-3.p-sm-4.p-md-5.mb-5
      .bloque-texto-g__img(
    ...
    h4.bgr_4.p-3.mb-5 La resiliencia como estrategia adaptiva
    ...
    .row.mb-5
      .col-12.col-lg-8
        ...
        .bgr_5.p-4
          p.mb-0 La resiliencia de los ecosistemas se define como la capacidad de recuperarse de un trauma o resistir tensiones en marcha; significa que los complicados procesos físicos y ciclos biogeoquímicos que llevan a cabo los factores bióticos y abióticos de un ecosistema en un periodo determinado, son para restaurar su situación anterior frente al resultado producido por factores externos y en ese sentido, recuperar y mantener la estabilidad del ecosistema.
      .col-12.col-lg-4
        figura
          img(src='@/assets/curso/tema1/t1-7.png' alt='Texto que describa la imagen')
    
    h4.bgr_4.p-3.mb-5 Ciclos biogeoquímicos
    ...
    .row.mb-5
      ...
      .col-12.col-lg-4.mb-5.mb-lg-0
        .tarjeta-avatar
          img.img120(src='@/assets/curso/tema1/t1-11.svg' alt='AvatarTop')
          .tarjeta.bgr_7
            .row.justify-content-center
              .col-7
    ...
    .bgr_5.p-4.mb-5
      p Estos ciclos son los encargados de que los elementos químicos fundamentales sean nuevamente reutilizados, si no fuese así, se acabaría y sería imposible la vida sobre el planeta. 
      p.mb-0 De esta manera, los ciclos biogeoquímicos son los diferentes procesos de los que la naturaleza facilita circular la materia de unos seres vivos a otros, concediendo así que una cierta parte esté disponible para siempre. Los seres vivos no requieren quedarse en su interior con los nutrientes. Los nutrientes deben ser devueltos al medio ambiente para que puedan ser reciclados por otros. 
    
    span A continuación, se describen algunos tipos de 
    span.colr.text-bold ciclos biogeoquímicos:

    .tarjeta.bgr_9.p-4.mt-5.mb-5
      SlyderA(tipo="b")
        .row.p-5
    ...
    h4.bgr_4.p-3.mb-5 Flujos y transformación de energía
      ...
      .col-12.col-lg-4
        .bgr_10.p-4.h-100
          figure.mb-3.d-flex.justify-content-center
            img.img120(src='@/assets/curso/tema1/t1-15.svg', alt='Texto que describa la imagen')
          .text-center
            h4 Productores
          p Son los que atraen y utilizan la energía solar para transformar la materia inorgánica en orgánica como son los organismos autótrofos.
      .col-12.col-lg-4
        .bgr_10.p-4.h-100
          figure.mb-3.d-flex.justify-content-center
            img.img120(src='@/assets/curso/tema1/t1-16.svg', alt='Texto que describa la imagen')
          .text-center
            h4 Consumidores
          p Son los que se alimentan de los productores obteniendo así la energía y materia que necesita conocidos como organismos heterótrofos y están clasificados en consumidores primarios, secundarios y terciarios según la depredación.
      .col-12.col-lg-4
        .bgr_10.p-4.h-100
          figure.mb-3.d-flex.justify-content-center
    ...
    .row.bgr_11.p-4.justify-content-center
      .col-12.col-lg-9
        .titulo-sexto.color-acento-contenido
          h5 Figura 3
    ...
    .bg_grad-04
      .row.mb-5
        .col-12.col-lg-4
          figura
            img(src='@/assets/curso/tema1/t1-19.svg' alt='Texto que describa la imagen') 
      ...
      .col-12.col-lg-9
        ImagenInfografica.color-acento-botones.mb-5
          template(v-slot:imagen)
            figure
              img(src='@/assets/curso/tema1/t1-20.svg', alt='Texto que describa la imagen')
    ...
    .bloque-texto-a.bgr_13.p-4.p-md-5.mb-5 
      .row.m-0.align-items-center.justify-content-between 
        .col-lg-8
          .bloque-texto-a__texto.px-4.py-5
            p.mb-0 La exigencia de proceder hacia la economía circular en Colombia inicia con los desafíos de conservar los recursos existentes en el país y la capacidad para utilizarlos en diferentes ciclos productivos creando un valor agregado, impulsando la productividad y buscando apertura de nuevos mercados de exportación con productos innovadores. 
        .col-lg-4.mb-4.mb-lg-0
          figura.d-flex.justify-content-center
            img.img250(src='@/assets/curso/tema1/t1-22.svg' alt='Texto que describa la imagen') 
         
    h4.bgr_4.p-3.mb-5 Metabolismo de materiales, agua y energía

    .row.bgr_14.p-4
      .col-12.col-lg-5.d-flex.align-items-center
        p.mb-0 El equilibrio del metabolismo es analizado por el uso de agua, energía y la extracción de materia prima, así como las importaciones y exportaciones de acuerdo con el consumo. Es el fundamento para comprender la sostenibilidad ambiental de un país, de acuerdo con su uso, exceso o escasez de recursos; a la vez, es el análisis de materias primas y recursos lo que proporciona un indicador del tamaño y escala de la actividad económica en el país. Veamos una explicación al respecto:
      .col-12.col-lg-7
        figura
    ...
    .row.bgr_5.p-4.mb-5
      .col-12.col-lg-2.d-flex.align-items-center
        figure.d-flex.justify-content-center
          img.img120(src='@/assets/curso/tema1/t1-27.svg', alt='Texto que describa la imagen')
      .col-12.col-lg-10 
    ...
    .bg_grad-05
      .row.justify-content-center
        .col-12.col-lg-8
          .titulo-sexto.color-acento-contenido
            h5 Figura 5
            span Estimación del metabolismo de la economía colombiana
          ImagenInfografica.color-acento-botones.mb-5
            template(v-slot:imagen)
              figure
            ...
            .tarjeta.bgr_15.p-3(x="5%" y="20%" numero="+")
              ...
              ul.fa-ul
                li
                  ...
                  | Biomasa  de madera y pescado (3%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Ganadería (23%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Biomasa de cultivos (13%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                ...
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Minerales y materiales industriales (2%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Hidrocarburos (29%)
              ...
              ul.fa-ul
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Biomasa  de madera y pescado (5%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Biomasa de cultivos (40%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Materiales de construcción (1%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Minerales y materiales industriales (25%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Hidrocarburos (29%)
            ...
            .tarjeta.bgr_15.p-3(x="99%" y="34%" numero="+")
              ...
              ul.fa-ul
                ...
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Materiales de Construcción (1,5%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Minerales y materiales industriales (0,5%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Hidrocarburos (90%)
              ...
              ul.fa-ul
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Biomasa  de madera y pescado (2%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Biomasa de cultivos (50%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Materiales de construcción (30%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Minerales y materiales industriales (8%)
                li
                  i.fa-li.fas.fa-chevron-right.colr_1
                  | Hidrocarburos (10%)
    
    h4.bgr_4.p-3.mb-5 Flujos de materiales prioritarios
    ...
    .row.justify-content-center
      .col-12.col-lg-9
        ImagenInfografica.color-acento-botones.mb-5
          template(v-slot:imagen)
            figure
              img(src='@/assets/curso/tema1/t1-29.svg', alt='Texto que describa la imagen')
