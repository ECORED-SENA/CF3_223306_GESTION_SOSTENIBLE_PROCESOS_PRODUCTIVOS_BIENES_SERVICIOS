        ...
        ol.lista-ol--cuadro
          li 
            .lista-ol--cuadro__vineta
              span a
            | Comprender la relación entre las variables económicas, ya sea en formulación y comprobación de hipótesis. 
          li 
            .lista-ol--cuadro__vineta
              span b
            | Diagnosticar un fenómeno o situación en particular. 
          li 
            .lista-ol--cuadro__vineta
              span c
    ...
    .bloque-texto-a.bgr_19.p-4.p-md-5.mb-5(data-aos="flip-left") 
      .row.m-0.align-items-center.justify-content-between 
        .col-lg-4.mb-4.mb-lg-0
          figura.d-flex.justify-content-center
            img.img250(src='@/assets/curso/tema2/t2-11.svg' alt='Texto que describa la imagen') 
        .col-lg-8
